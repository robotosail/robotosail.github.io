...
let front_topwall1, front_topwall1Body,
  ...
  front_topbackwall1, front_topbackwall1Body,
  insidewall11, insidewall11Body,
  insidewall12, insidewall12Body;
let front_topwall2, front_topwall2Body,
  front_topleftwall2, front_topleftwall2Body,
  front_toprightwall2, front_toprightwall2Body,
  front_topbackwall2, front_topbackwall2Body,
  insidewall21, insidewall21Body,
  insidewall22, insidewall22Body;

  const wallmaterial = new CANNON.Material("wallMaterial"), friction = 1, restitution = 0.3;
...
function house() {
  ...
  function house1() {
    ...
    // roof
    roofBody.position.set(-150, -35, -33);

    // roof patch
    roofpatch2Body.position.set(-90, -35, 56.5);
    //left wall
    ...
    //front wall
    cubeBody.position.set(-80.5, -15, 17);
  ...
  function tophouse1() {
    ...
    // the front top wall
    front_topbackwall2Body.position.set(-200, -53, -24);
    ...
    insidewall12Body.position.set(-142, -50.5, 29);
